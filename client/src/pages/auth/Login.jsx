        ...
        <div className="mt-6 border-t border-gray-200 pt-6">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="bg-gray-50 p-2 rounded">
              ...
              <p className="text-gray-600">admin@newsroom.com</p>
            </div>
            <div className="bg-gray-50 p-2 rounded">
              <p className="font-semibold text-gray-700">Editor</p>
              <p className="text-gray-600">editor@newsroom.com</p>
            </div>
            <div className="bg-gray-50 p-2 rounded">
              <p className="font-semibold text-gray-700">Writer</p>
              <p className="text-gray-600">writer@newsroom.com</p>
            </div>
            <div className="bg-gray-50 p-2 rounded">
              <p className="font-semibold text-gray-700">Reader</p>
              <p className="text-gray-600">reader@newsroom.com</p>
            </div>
          </div>
